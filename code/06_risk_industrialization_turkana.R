################################################################################
#
# RISK FACTORS × INDUSTRIALIZATION — TURKANA
# Causal effect of industrialization on six risk factor outcomes (Turkana only)
#
# This script estimates the causal effect of industrialization (continuous
# exposure) on six risk factor outcomes among the Turkana:
#   - BMI (continuous)
...
#
# Output: models/risk_industrialization_turkana.Rdata
#
################################################################################
...
risk_bmi_turkana # n: 1138, ESS: 1074.1
...
risk_waist_turkana # n: 1130, ESS: 1067.5
...
risk_fat_turkana # n: 1021, ESS: 967.9
...
risk_crp_turkana # n: 363, ESS: 362.5
...
risk_steps_turkana # n: 224, ESS: 200.3
...
risk_mvpa_turkana # n: 224, ESS: 200.3
...
save(
  ...
  risk_steps_turkana,
  risk_mvpa_turkana,
  file = "models/risk_industrialization_turkana.Rdata",
  compress = "gzip"
)
